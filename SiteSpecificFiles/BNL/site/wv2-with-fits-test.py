...
#arcsub.synchCommand(10,"setFitsDirectory","/home/ts3prod/prod/BNL2/wvfits-filter1");

fp = open("/home/ts3prod/prod/BNL2/results-wv-with-fits-filter1-test.dat","w");

for wl in range(300,1100,2):
...
#    result = biassub.synchCommand(10,"readcurrent");
    ...
    fitsfilename = "wv-test-%d_${timestamp}.fits" % wl
