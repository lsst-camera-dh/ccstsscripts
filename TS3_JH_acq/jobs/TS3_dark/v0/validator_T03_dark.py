...
cdir = "/home/homer/lsst/lcatr/share/T03_dark/v0";
...
results.append(lcatr.schema.valid(lcatr.schema.get('T03_dark'),stat=tsstat,volt=tsvolt,curr=tscurr,pres=tspres,temp=tstemp))
