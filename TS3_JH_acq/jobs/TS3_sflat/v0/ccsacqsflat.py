###############################################################################
# sflat
# Acquire sflat image pairs for linearity and gain measurement.
# For each 'sflat' command a pair of sflat field images are acquired
#
# In the configuration file the format for a sflat command is
# sflat   signal  
