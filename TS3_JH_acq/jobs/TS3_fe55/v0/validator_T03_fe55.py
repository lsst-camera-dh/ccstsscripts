...
cdir = "/home/homer/lsst/lcatr/share/T03_fe55/v0";
...
results.append(lcatr.schema.valid(lcatr.schema.get('T03_fe55'),stat=tsstat,volt=tsvolt,curr=tscurr,pres=tspres,temp=tstemp))
